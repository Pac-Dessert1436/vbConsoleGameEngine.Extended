...
next4:
  ...
  Private Class AudioSample
    ...
    Public Sub New(sWavFile As String)
      ...
      f.ReadExactly(headerBytes, 0, length)
      ...
      f.ReadExactly(dump, 0, 4) ' Read chunk header
      f.ReadExactly(BitConverter.GetBytes(nChunksize), 0, 4) ' Read chunk size
      While System.Text.Encoding.ASCII.GetString(dump, 0, 4) <> "data"
        ...
        f.ReadExactly(dump, 0, 4)
        f.ReadExactly(BitConverter.GetBytes(nChunksize), 0, 4)
      End While
      ...
      For i = 0 To nSamples - 1
        For c = 0 To nChannels - 1
          Dim s = 0
          f.ReadExactly(BitConverter.GetBytes(s), 0, 2)
